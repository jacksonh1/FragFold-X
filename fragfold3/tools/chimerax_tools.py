...
ALIGN_SCRIPT_FILE = files("fragfold3.scripts").joinpath("align_structures_chimerax.py")
...
ALIGN_EXPORT_SCRIPT_FILE = files("fragfold3.scripts").joinpath("align_and_export_pdbs_chimerax.py")
