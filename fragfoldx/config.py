...
# CHIMERAX_ALIGNMENT_SCRIPT = files("fragfoldx.local_data").joinpath(
...
# ==============================================================================
executables_file = [
    i for i in files("fragfoldx").iterdir() if i.name == "executables.yaml"
][0]
...
logger.info(f"fragfoldx PROJ_ROOT path is: {PROJ_ROOT}")
...
# version
# try:
#     from fragfoldx import __version__
# except ImportError:
#     __version__ = "0.0.0"
